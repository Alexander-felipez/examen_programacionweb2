        ...
        <div class="card">
            ...
            <form action="{{ route('clientes.store') }}" method="POST">
                ...
                <div class="grid">
                    <div class="form-group">
                        <label>Marca</label>
                        <input type="text" name="vehiculo_marca" value="{{ old('vehiculo_marca') }}" required>
                    </div>
                    <div class="form-group">
                        <label>Modelo</label>
                        <input type="text" name="vehiculo_modelo" value="{{ old('vehiculo_modelo') }}" required>
                    </div>
                    <div class="form-group">
                        <label>Placa</label>
                        <input type="text" name="vehiculo_placa" value="{{ old('vehiculo_placa') }}" required>
                    </div>
                </div>
